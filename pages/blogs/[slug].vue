    ...
    <div class="mx-auto max-w-3xl text-base/7 text-gray-700">
      ...
      <div v-for="content in blog.content" class="my-10" id="content">
          <div v-if="content['__component'] == 'shared.rich-text'">
              <h1 id="rich-text-heading" v-if="content.heading">{{ content.heading }}</h1>
              <div id="rich-text-body" v-if="content.body" v-html="content.body"></div>
          </div>
          <div v-if="content['__component'] == 'shared.media'" v-html="content.media" />
          <div v-if="content['__component'] == 'shared.media'" v-html="content.media" />
      </div>
...
useSeoMeta({
  ...
  // ogImage: blog.value.seo.sharedImage,
  // twitterCard: blog.value.seo.sharedImage,
})
</script>
