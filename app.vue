    ...
    <header class="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div class="container flex h-16 items-center justify-between">
        ...
        <nav class="hidden md:flex items-center space-x-8 text-sm font-medium">
          <NuxtLink 
            v-for="link in ['Home', 'Projects', 'About', 'Contact']" 
            :key="link"
            ...
            <CardContent>
              <div class="space-y-6">
                <div 
                  ...
                  :key="project.name" 
                  class="group relative overflow-hidden rounded-lg border p-4 transition-all hover:bg-muted/50"
                >
...
const projects = [
  {
    name: "Project One",
    description: "A full-stack web application built with Vue and Node.js"
  },
  {
    name: "Project Two",
...
const skills = [
  {
    name: "Frontend",
    description: "Vue.js, Nuxt, React, HTML, CSS, Tailwind"
  },
  {
    name: "Backend",
